...
@Service
public class AnyCookingItemListKitchenUtensilService implements AbstractListService<Any, CookingItem> {
	...
	public Collection<CookingItem> findMany(final Request<CookingItem> request) {
		...
		return this.repository.findPublishedKitchenUtensils();
	}
