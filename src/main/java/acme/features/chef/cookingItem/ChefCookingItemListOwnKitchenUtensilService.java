...
@Service
public class ChefCookingItemListOwnKitchenUtensilService implements AbstractListService<Chef, CookingItem> {
	...
	public Collection<CookingItem> findMany(final Request<CookingItem> request) {
		...
		res = this.repository.findKitchenUtensilsByChefId(id);
