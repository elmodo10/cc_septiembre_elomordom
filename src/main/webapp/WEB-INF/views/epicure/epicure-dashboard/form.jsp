...
<div class="dp2-base">
   <div class="totals">
         ...
         <c:forEach items="${Status.values()}" var="status">
            <div class="col">
               <div class="card">
                  <div class="card-body">
                     <label>
                        <acme:message code="patron.dashboard.form.label.totalfinedishes${status}" />
                        <input type="text" value="${totalNumberFineDishes[status]}" readonly />
                     </label>
                  </div>
               </div>
            </div>
      ...
      <c:forEach items="${Status.values()}" var="status">
         <h3>
            <acme:message code="patron.dashboard.form.label.finedishes${status}" />
         </h3>
         <c:forEach items="${FineDishesBudgets[status]}" var="data">
            <h4>
